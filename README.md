...
举例 WebXR 硬件装备![Sketch of a person in a chair with wearing goggles labelled "Head mounted display (HMD)" facing a monitor with a webcam labeled "Position sensor"](https://developer.mozilla.org/zh-CN/docs/Web/API/WebXR_Device_API/hw-setup.png)
